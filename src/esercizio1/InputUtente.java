	...
	public void sceltaUtente() {
		...
		while (!fine) {
			try {
				...
				System.out.println("Inserisci il numero " + num + " che hai appena scelto in una posizione dell'array [1 - 5]: ");
				...
				System.out.println("Inserisci un valore valido."); // stampa il messaggio errato
			}
		}
		in.close();
	}
